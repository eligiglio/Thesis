...
Scientists are working on alternative workflows where the treatment is adapted everyday, or even on fly while the patient is on the couch. This method is called adaptive radiotherapy.
...
%%% substitue the image witht the correct one
\begin{figure}[!t]
\centering
\subfloat[][\emph{MatRad}]
{\includegraphics[width=.25\textwidth]{Images/mR_FSBvsMC_pub_soukup/mR_FSBvsMC_pub_soukup_14}}\quad
...
In this case, I decided to show three longitudinal profiles: the central one, where there is a good agreement between Monte Carlo and fine sampling; and two shifted of three voxel in opposite lateral directions, where there is a difference in dose in the initial part of the path (clearer in the most energetic beam in figures \ref{} and \ref{}).

%The Bragg peak is bended towards right (in respect to the beam eye view) instead, it should be bent in the other direction.
