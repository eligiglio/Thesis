...
%\node (wei) [process, below of=geo] {Calculate weights};
%\node (loopbixel) [decision, below of=wei, yshift=-1.3cm] {For each Bixel};
%\node (proj) [process, below of=loopbixel, yshift=-1.3cm] {Projection};
%\node (loopsb) [decision, below of=proj, yshift=-1.3cm] {For each Component};
%\node (calcdose) [process, below of=loopsb, yshift=-1.3cm] {Calculate Dose};
...
%\draw [arrow] (loopray) -- (geo);
%\draw [arrow] (geo) -- (wei);
%\draw [arrow] (wei) -- (loopbixel);
%\draw [arrow] (loopbixel) -- (proj);
%\draw [arrow] (proj) -- (loopsb);
%\draw [arrow] (loopsb) -- (calcdose);
%\draw [arrow] (calcdose) -- (store);
